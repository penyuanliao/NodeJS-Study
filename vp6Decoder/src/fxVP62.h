...
public:
    ...
    void    getRGB2(byte *rgb);
    void	getYUV(byte* yuv, int* pitch);
    void    getYUV2(byte* yuv);//byte* y, byte* u, byte* v, int pitch
};

//extern "C"
//{
//    extern void createStream(){
//        printf("createStream start \n");
//        fxVP62 *pVP62;
//        printf("%u",pVP62->testValue);
//    };
//    extern int vp6DecodePacket(unsigned char* payload, int length);
//    extern void vp6GetImageSize(int *width, int *height);
//    extern void vp6GetDisplaySize(int *with, int *height);
//    extern void vp6GetRGB(unsigned char* rgb);
//    extern void vp6GetYUV(unsigned char** yuv, int* pitch);
//}
